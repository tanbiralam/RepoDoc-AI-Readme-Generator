...
export default function DirectAuthPage() {
  ...
  const handleDirectGitHubLogin = () => {
    ...
    const url = `https://github.com/login/oauth/authorize?client_id=${githubClientId}&redirect_uri=${encodeURIComponent(redirectUri)}&scope=${scope}`;
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      ...
      <p className="mb-4 text-gray-600 max-w-md text-center">
        This page bypasses Supabase's authentication flow to directly call GitHub's OAuth API.
        It will help us debug the redirect URI issue.
      </p>
      
      <div className="mb-6 bg-gray-100 p-4 rounded">
        <h2 className="font-semibold mb-2">Debug Information:</h2>
        <p><strong>Client ID:</strong> {clientId || 'Not available'}</p>
