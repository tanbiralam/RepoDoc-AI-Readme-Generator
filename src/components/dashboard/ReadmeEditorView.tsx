...
export default function ReadmeEditorView({
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl shadow-lg border border-gray-800 overflow-hidden transition-all duration-300 hover:shadow-indigo-500/5">
