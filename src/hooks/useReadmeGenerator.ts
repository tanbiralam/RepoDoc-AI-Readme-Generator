      ...
      try {
        ...
        if (aiError) {
          ...
          if (isRateLimit) {
            ...
            showWarning(
              "Rate limit reached. Please try again later or upgrade your plan for higher limits. 🚫",
              6000
            );
            setError(
              "Rate limit exceeded. Please wait before generating another README."
            );
            return;
          }
