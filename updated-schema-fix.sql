-- Fixed schema for the ReadMe Generator that resolves profile creation issues
...
-- Create a revised trigger to automatically create a profile when a new user signs up
